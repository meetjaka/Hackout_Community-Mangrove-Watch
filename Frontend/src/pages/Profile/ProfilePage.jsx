...
import { MapPin, Mail, Phone, Building, User, Camera, Save, Shield, Award } from 'lucide-react';
...
const ProfilePage = () => {
  ...
  const { register: registerProfile, handleSubmit: handleProfileSubmit, formState: { errors: profileErrors }, setValue: setProfileValue, reset: resetProfile } = useForm();
  ...
  useEffect(() => {
    ...
    if (user) {
      ...
      setProfileValue('organization', user.organization || '');
      ...
      if (user.roleSpecificInfo) {
        Object.keys(user.roleSpecificInfo).forEach(key => {
          setProfileValue(`roleSpecificInfo.${key}`, user.roleSpecificInfo[key]);
        });
      }
    }
  ...
  const onProfileSubmit = async (data) => {
    ...
    try {
      ...
      if (data.roleSpecificInfo) {
        formData.append('roleSpecificInfo', JSON.stringify(data.roleSpecificInfo));
      }
  ...
  return (
    <div className="py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className={`input-field pl-10 ${
                          profileErrors.firstName ? 'border-danger-500 focus:ring-danger-500' : ''
                        }`}
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        type="text"
                        className={`input-field pl-10 ${
                          profileErrors.lastName ? 'border-danger-500 focus:ring-danger-500' : ''
                        }`}
                ...
                <div className="mt-6">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      type="tel"
                      className={`input-field pl-10 ${
                        profileErrors.phone ? 'border-danger-500 focus:ring-danger-500' : ''
                      }`}
              ...
              {user?.role && (
                <div className="mb-6">
                  <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-4">
                    {user.role.replace('_', ' ').replace(/\b\w/g, l => l.toUpperCase())} Information
                  </h3>
                  
                  {user.role === 'fisherman' && (
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div>
                        <label htmlFor="boatNumber" className="form-label">Boat Registration Number</label>
                        <input
                          id="boatNumber"
                          type="text"
                      ...
                      <div>
                        <label htmlFor="fishingArea" className="form-label">Primary Fishing Area</label>
                        <input
                          id="fishingArea"
                          type="text"
                          className="input-field"
                  ...
                  {user.role === 'coastal_resident' && (
                    <div>
                      <label htmlFor="area" className="form-label">Residential Area</label>
                      <input
                        id="area"
                        type="text"
                        className="input-field"
                  ...
                  {user.role === 'government_officer' && (
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      ...
                      <div>
                        <label htmlFor="jurisdiction" className="form-label">Area of Jurisdiction</label>
                        <input
                          id="jurisdiction"
                          type="text"
                          className="input-field"
                  ...
                  {user.role === 'researcher' && (
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div>
                        <label htmlFor="institution" className="form-label">Research Institution</label>
                        <input
                          id="institution"
                          type="text"
                          className="input-field"
                      ...
                      <div>
                        <label htmlFor="researchArea" className="form-label">Research Focus Area</label>
                        <input
                          id="researchArea"
                          type="text"
                          className="input-field"
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div>
                        ...
                        <input
                          ...
                          type="number"
                          className="input-field"
                          {...registerProfile('roleSpecificInfo.experienceYears')}
                        />
                      </div>
                      <div>
                        <label htmlFor="area" className="form-label">Area of Operation</label>
                        <input
                          id="area"
                          type="text"
                          className="input-field"
              ...
              <div className="mb-6">
                ...
                <div className="mb-6">
                  ...
                  <input
                    ...
                    type="password"
                    className={`input-field ${
                      passwordErrors.currentPassword ? 'border-danger-500 focus:ring-danger-500' : ''
                    }`}
                ...
                <div className="mb-6">
                  ...
                  <input
                    ...
                    type="password"
                    className={`input-field ${
                      passwordErrors.newPassword ? 'border-danger-500 focus:ring-danger-500' : ''
                    }`}
                ...
                <div className="mb-6">
                  ...
                  <input
                    ...
                    type="password"
                    className={`input-field ${
                      passwordErrors.confirmNewPassword ? 'border-danger-500 focus:ring-danger-500' : ''
                    }`}
                  ...
                  {passwordErrors.confirmNewPassword && (
                    <p className="mt-1 text-sm text-danger-600">{passwordErrors.confirmNewPassword.message}</p>
                  )}
                </div>
              </div>
        ...
        {activeTab === 'achievements' && (
          <div className="card p-6">
            <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-6">Your Achievements</h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="card bg-gradient-to-br from-amber-50 to-amber-100 dark:from-amber-900/20 dark:to-amber-800/20 border border-amber-200 dark:border-amber-700 p-6 flex flex-col items-center text-center">
                ...
                <h4 className="text-lg font-semibold text-amber-800 dark:text-amber-300">First Report</h4>
              ...
              <div className="card bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900/20 dark:to-gray-800/20 border border-gray-200 dark:border-gray-700 p-6 flex flex-col items-center text-center opacity-60">
                ...
                <h4 className="text-lg font-semibold text-gray-800 dark:text-gray-300">Frequent Reporter</h4>
                <p className="text-sm text-gray-700 dark:text-gray-400 mt-2">
                  Submit 10 reports to unlock this achievement
                </p>
                <div className="mt-4 flex items-center">
                  <div className="w-full bg-gray-200 dark:bg-gray-700 h-2 rounded-full overflow-hidden">
                    <div className="bg-primary-500 h-full rounded-full" style={{ width: '30%' }}></div>
                  </div>
                  <span className="ml-2 text-xs font-medium text-gray-600 dark:text-gray-400">3/10</span>
                </div>
              </div>
              ...
              <div className="card bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900/20 dark:to-gray-800/20 border border-gray-200 dark:border-gray-700 p-6 flex flex-col items-center text-center opacity-60">
                ...
                <h4 className="text-lg font-semibold text-gray-800 dark:text-gray-300">Community Champion</h4>
                <p className="text-sm text-gray-700 dark:text-gray-400 mt-2">
                ...
                <div className="mt-4 flex items-center">
                  ...
                  <span className="ml-2 text-xs font-medium text-gray-600 dark:text-gray-400">1/5</span>
                </div>
              </div>
            </div>
          </div>
